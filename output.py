...
country_dict1 = collections.OrderedDict([
    ...
    (('канад','оттав'),'Канада'),
    (('\\bдатск', '\\bес\\b', '\\bиспан', '\\bкосов[оес]', '\\bнато\\b', '\\bпольс', '\\bрим\\b', '\\bрима\\b', 'soir',
      'австри', 'албан', 'англи', 'афин', 'балтик', 'белград', 'бельг', 'берлин', 'болгар', 'бридлав', 'британ',
      'брюссел', 'бундес', 'варшав', 'вена', 'венгер', 'венгр', 'вене ', 'герман', 'голланд', 'греци', 'греческ',
      '\\bдании', 'европ[^о]', 'евросоюз', 'женев[ае]', 'ирланд', 'исланд', 'итали', 'итальян', 'кипр', 'копенгаген',
      'латви', 'лейпциг', 'литва', 'литве', 'литву', 'литвы', 'литовск', 'лондон', 'мадрид', 'македони', 'марсел',
      'меркель', 'милан', 'немец', 'нидерланд', 'ницц', 'норвеги', 'норвежск', 'олланд', 'париж', 'польш', 'португал',
      'расмуссен', 'риг[а-я]\\b', 'риг[а-я]{,2}', 'румын', 'сааб', 'североатлант', 'серби', 'скопье', 'словак',
      'словен', 'талес', 'финлянд', 'финск', 'франкфурт', 'франц[а-я]{2,}', 'фрг', 'хорват', 'цюрих', 'черногор',
      'чехи', 'чешск', 'швед', 'швейцар', 'швеци', 'эстон'),'Европа'),
