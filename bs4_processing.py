    ...
    def vpk(self):
        ...
        try:
            ...
            if len(self.main_text_class) > 4000:
                error_log('%%%%%Скорее всего это был анализ.УДАЛЕНО.\n')
                return 'no_interest'
        except Exception as e:
            error_log('%%%%%В {} не найдено self.main_text_class.\n'.format(self.rss_name))
            return False
